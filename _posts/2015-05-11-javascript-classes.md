...
JavaScript has objects, and by default, those objects are dictionaries. By default, objects can directly manipulate each other's state. Methods can be added to, or removed from objects at run time.
